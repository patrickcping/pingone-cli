...
```bash
pingone-cli v1EnvironmentsEnvIDSignOnPoliciesGet envID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDSignOnPoliciesPolicyIDDelete envID=value policyID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDSignOnPoliciesPolicyIDGet envID=value policyID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDSignOnPoliciesPolicyIDPut envID=value policyID=value Content-Type:value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDSignOnPoliciesPost envID=value Content-Type:value Authorization:value
```
