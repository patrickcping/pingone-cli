...
```bash
pingone-cli v1EnvironmentsEnvIDLanguagesGet envID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDLanguagesLanguageIDDelete envID=value languageID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDLanguagesLanguageIDGet envID=value languageID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDLanguagesLanguageIDPut envID=value languageID=value Content-Type:value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDLanguagesPost envID=value Content-Type:value Authorization:value
```
