...
```bash
pingone-cli v1EnvironmentsEnvIDApplicationsAppIDSecretGet envID=value appID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDApplicationsAppIDSecretPost envID=value appID=value Content-Type:value Authorization:value
```
