...
```bash
pingone-cli deleteApplicationAttributeMapping envID=value appID=value attrMappingID=value
```
 ...
 **envID** | **string** |  | [default to null]
 **appID** | **string** |  | [default to null]
 **attrMappingID** | **string** |  | [default to null]
...
```bash
pingone-cli readOneApplicationAttributeMapping envID=value appID=value attrMappingID=value
```
...
```bash
pingone-cli updateApplicationAttributeMapping envID=value appID=value attrMappingID=value
```
