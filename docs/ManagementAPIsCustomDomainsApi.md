...
```bash
pingone-cli v1EnvironmentsEnvIDCustomDomainsDomIDDelete envID=value domID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDCustomDomainsDomIDGet envID=value domID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDCustomDomainsDomIDPost envID=value domID=value Content-Type:value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDCustomDomainsGet envID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDCustomDomainsPost envID=value Content-Type:value Authorization:value
```
