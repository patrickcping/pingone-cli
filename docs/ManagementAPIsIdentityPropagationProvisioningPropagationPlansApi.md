...
```bash
pingone-cli v1EnvironmentsEnvIDPropagationPlansGet envID=value Accept:value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDPropagationPlansPlanIDDelete envID=value planID=value Accept:value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDPropagationPlansPlanIDGet envID=value planID=value Accept:value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDPropagationPlansPlanIDPut envID=value planID=value Content-Type:value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDPropagationPlansPost envID=value Content-Type:value Authorization:value
```
