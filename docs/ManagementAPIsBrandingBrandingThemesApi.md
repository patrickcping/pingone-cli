...
```bash
pingone-cli v1EnvironmentsEnvIDThemesGet envID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDThemesPost envID=value Authorization:value Content-Type:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDThemesThemeIDDefaultGet envID=value themeID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDThemesThemeIDDefaultPut envID=value themeID=value Authorization:value Content-Type:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDThemesThemeIDDelete envID=value themeID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDThemesThemeIDGet envID=value themeID=value Authorization:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDThemesThemeIDPut envID=value themeID=value Authorization:value Content-Type:value
```
