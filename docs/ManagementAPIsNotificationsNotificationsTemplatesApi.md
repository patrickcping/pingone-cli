...
```bash
pingone-cli v1EnvironmentsEnvIDTemplatesGet envID=value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDTemplatesTemplateNameContentsContentIDDelete envID=value templateName=value contentID=value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDTemplatesTemplateNameContentsDelete envID=value templateName=value  filter=value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDTemplatesTemplateNameContentsGet envID=value templateName=value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDTemplatesTemplateNameContentsPatch envID=value templateName=value  filter=value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDTemplatesTemplateNameGet envID=value templateName=value
```
