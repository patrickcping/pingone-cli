...
```bash
pingone-cli v1EnvironmentsEnvIDResourcesResourceIDAttributesGet envID=value resourceID=value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDResourcesResourceIDAttributesPost envID=value resourceID=value Content-Type:value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDResourcesResourceIDAttributesResourceAttrIDDelete envID=value resourceID=value resourceAttrID=value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDResourcesResourceIDAttributesResourceAttrIDGet envID=value resourceID=value resourceAttrID=value
```
...
```bash
pingone-cli v1EnvironmentsEnvIDResourcesResourceIDAttributesResourceAttrIDPut envID=value resourceID=value resourceAttrID=value Content-Type:value
```
